...
class SamplerMultiTaskTrainer(MultiTaskTrainer):
    ...
    def train(self, recover: bool = False):
        ...
        -------
        return_dict: Dict
            A dictionary summarizing the training and the metrics for the best epochs for each tasks.
        """
        ...
        while not should_stop:
            ...
            for task_idx, task in enumerate(self._task_list):
                ...
                for batch in val_generator_tqdm:
                    ...
                    # Get the loss
                    val_output_dict = self._forward(batch, task=task, for_training=True)
